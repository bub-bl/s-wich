...
/// <summary>
/// Parses the CSS named colors (plus <c>transparent</c>). Lookup is
/// case-insensitive. This is the last-resort format, after the structured
/// syntaxes.
/// </summary>
public sealed class NamedColorFormat : ICssColorFormat
{
    public string Name => "named";

    public bool TryParse(string input, out UiColor color) => NamedColors.TryGetValue(input, out color);

...
public sealed class StatusBar : UserControl
{
    public StatusBar()
    {
        ...
        var selected = new TextBlock
        {
            ...
            FontSize = 10, Foreground = Brush.Parse("#A1A1AA"), HorizontalAlignment = HorizontalAlignment.Center
        };
        ...
        Content = new Border { Background = Brush.Parse("#09090B"), Padding = new Thickness(8, 2), Child = grid };
    }
}
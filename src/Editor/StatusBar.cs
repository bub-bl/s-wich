...
public sealed class StatusBar : EditorControl
{
    protected override Control BuildUi()
    {
        ...
        var ready = new TextBlock { Text = "● Engine Ready", FontSize = 10, Foreground = EditorTheme.Brush(EditorTheme.Success) };
        ...
        { Text = "Avalonia 12 + Silk.NET 2.23 (WGPU)", FontSize = 10, Foreground = EditorTheme.Brush(EditorTheme.TextSubtle) };
        ...
        return new Border { Background = EditorTheme.Brush(EditorTheme.StatusBackground), Padding = new Thickness(8, 2), Child = grid };
    }
}
